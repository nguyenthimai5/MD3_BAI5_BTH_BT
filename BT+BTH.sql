...
explain select * from customers c Where c.customerName='Land of Toys Inc.';
...
as select c.customerNumber ,c.customerName ,c.phone
from customers c;
select * from customer_view;

create or replace view customer_view as
select c.customerNumber,c.customerName,c.contactFirstName,c.contactLastName,c.phone
from customers c
where city ='Nantes';

delimiter &&
create procedure Productfields()
begin
select pr.productcode ,pr.productName,pr.buyPrice,pr.productDescription
from products pr;
end &&;
delimiter &&
call Productfields;
